 ...
 */
package org.exbin.xbup.intellij;
...
/**
 * File system for XBUP editor.
 *
 * @author ExBin Project (http://exbin.org)
 * @version 0.2.0 2021/12/18
 */
public class XbupFileSystem extends VirtualFileSystem {

    private static final String PROTOCOL = "xbup";
    private static final String ERROR_INVALID_OPERATION = "Invalid operation";
    private static final XbupFileSystem INSTANCE = new XbupFileSystem();
    private List<VirtualFileListener> fileListeners = new ArrayList<>();

    @NotNull
    public static XbupFileSystem getInstance() {
        return INSTANCE;
    }
